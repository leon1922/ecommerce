                ...
                <?php else : ?>
                    ...
                    <div class="billing-address">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h3 class="special">Currency Converter</h3>
                                <table class="table table-responsive table-bordered bill-address">
                                    <tr>
                                        <td>
                                            <!-- Currency convert starts -->
                                            <script>
                                                var fm = "USD";
                                                var to = "TZS";
                                                var tz = "timezone";
                                            ...
                                            <script src="//currencyrate.today/converter">
                                            </script>
                                            <div style="text-align:right"></div>
                                            <!--  END Currency convert CODE -->
                                        </td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <select name="payment_method" class="form-control select2" id="advFieldsStatus">
                                            ...
                                            <option value="Mpesa Deposit"><?php echo LANG_VALUE_164; ?></option>
                                        </select>
                                    </div>
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea name="transaction_info" class="form-control" cols="30" rows="10" placeholder="Example:BANK $20 548GDFVD21212" required></textarea>
                                        </div>
                                        <div class="col-md-12 form-group">
